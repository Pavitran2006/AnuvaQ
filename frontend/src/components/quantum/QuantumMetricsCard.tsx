  ...
  if (!metrics) {
    return (
      <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 text-center text-slate-500 text-xs">
        <Sparkles className="w-5 h-5 mx-auto mb-1 opacity-40 text-cyan-400" />
        Enable Noise Simulation to view Fidelity, Purity, and Von Neumann Entropy metrics.
      </div>
    );
  }
  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-4 shadow-xl backdrop-blur-md">
      <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-800">
        <h4 className="text-xs font-semibold text-slate-200 uppercase tracking-wider flex items-center gap-1.5 font-mono">
          <BarChart3 className="w-3.5 h-3.5 text-cyan-400" />
          Quantum Information Analytics
        </h4>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {/* State Fidelity */}
        <div className="bg-slate-950/80 border border-slate-800/80 rounded-lg p-3 relative overflow-hidden">
          ...
          <p className="text-[10px] text-slate-500 mt-0.5">Tr(ρ_ideal · ρ_noisy)</p>
          <div
        ...
        <div className="bg-slate-950/80 border border-slate-800/80 rounded-lg p-3 relative overflow-hidden">
          ...
          <p className="text-[10px] text-slate-500 mt-0.5">Tr(ρ²)</p>
          <div
        ...
        <div className="bg-slate-950/80 border border-slate-800/80 rounded-lg p-3 relative overflow-hidden">
          ...
          <div className="text-lg font-bold font-mono text-violet-400">
            {metrics.entropy.toFixed(3)} <span className="text-[10px] text-slate-400 font-normal">bits</span>
          </div>
          <p className="text-[10px] text-slate-500 mt-0.5">-Tr(ρ log₂ ρ)</p>
          <div
            className="absolute bottom-0 left-0 h-1 bg-violet-500 transition-all duration-500"
